...
import { Tag, Plus, Edit, Trash, Palette, Smile, Check } from 'lucide-react';
import { useTags, useDeleteTag, useUpdateTag } from '@/hooks/useTags';
          ...
          <Button variant="ghost" size="icon" onClick={async () => {
            if (window.confirm('Tem certeza que deseja excluir esta categoria?')) {
              try {
                ...
                toast({ title: 'Erro ao excluir', description: error?.response?.data?.message || error?.message || 'Não foi possível excluir.', variant: 'destructive' });
              }
            }
          }} title="Excluir">
