...
import { Receipt, ArrowUpRight, ArrowDownRight, Calendar, ArrowRight } from 'lucide-react';
...
interface TransacaoRecente {
  ...
  valor: number;
  tipo: 'GASTO' | 'RECEITA';
  data: string; // campo correto para data
  tag?: { nome: string; cor: string };
}
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={
                      `p-2 rounded-lg ${transacao.tipo === 'RECEITA' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`
                    }>
                  ...
                  <p className={
                    `font-semibold ${transacao.tipo === 'RECEITA' ? 'text-green-600' : 'text-red-600'}`
                  }>
                    {transacao.tipo === 'RECEITA' ? '+' : '-'}
